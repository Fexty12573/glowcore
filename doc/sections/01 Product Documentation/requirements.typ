...
#nfr_table(
  ...
  requirements: [Save files should remain compact and use an efficient binary serialization format. Under the currently defined maximum expected game progression and world configuration, a save file should not exceed 1 MB.],
