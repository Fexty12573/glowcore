...
#agenda_table((
  ...
  [Decide if we need a separate pdf for protocols], [Cedric Cathomas], [We decided that there's no use in having a separate page just for meeting minutes, so we have one thing less to worry about]
))
